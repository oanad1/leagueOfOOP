...
public final class AngelConstants {
    ...
    public static final int DARK_HP_P = 30;
    public static final int DARK_HP_R = 10;
    ...
    public static final int LG_HP_P = 80;
    public static final int LG_HP_R = 90;
    ...
    //Spawner Constants
    public static final int SPAWNER_HP_K = 200;
    public static final int SPAWNER_HP_P = 150;
    public static final int SPAWNER_HP_R = 180;
    public static final int SPAWNER_HP_W = 120;

    //XPAngel Constants
    public static final int XPANGEL_XP_K = 45;
    public static final int XPANGEL_XP_P = 50;
    public static final int XPANGEL_XP_R = 40;
    public static final int XPANGEL_XP_W = 60;
}
